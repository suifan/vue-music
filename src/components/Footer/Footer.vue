  ...
  <transition name="fade">
    <div v-show="isShowMiniMusic" :style="{backgroundColor: skinColor}" class="footer">
      <div class="mini-music">
        <div class="music-img">
          <img @click="showPlay" ref="img" :src="audio.musicImgSrc || (musicData[0]&&musicData[0].musicImgSrc)" :class="{'rotate':isPlaying}">
        </div>
        <div class="music-name">
          <p @click="showPlay">{{audio.name || (musicData[0]&&musicData[0].name) || 'Powered by lenshen.com'}}</p>
          <div class="progress">
